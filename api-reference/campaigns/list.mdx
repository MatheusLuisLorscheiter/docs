...
$response = file_get_contents('https://{url-key}/api/campaigns', false, stream_context_create([
    'http' => [
        'method' => 'GET',
        'header' => implode("\r\n", $headers)
    ]
...
1. Consultar Campanha Específica - Detalhes de uma campanha
2. Gerenciar Campanha - Pause, retome ou cancele
3. Criar Nova Campanha - Crie uma nova campanha