...
| `contacts[].phoneNumber` | string | Sim | Número de telefone do contato no formato 5511999999999 |
...
| `scheduledFor` | datetime | Não | Data e hora para agendamento no formato YYYY-MM-DDTHH:mm:ss |
