...
```json Exemplo com Mídia (Detecção Automática)
{
  "id": 2,
  "name": "Campanha com Imagem",
  "message": "Confira nossa promoção!",
  "mediaUrl": "https://exemplo.com/promo.jpg",
  "caption": "Oferta especial válida até domingo",
  "contacts": [...]
}
```

```json Exemplo com Base64
{
  "id": 3,
  "name": "Campanha com PDF",
...
```json Exemplo com Áudio e Texto
{
  "id": 4,
  "name": "Campanha de Áudio",
  "message": "Ouça as instruções acima com atenção",
...
<Note>
**Detecção Automática**: O sistema detecta automaticamente o tipo de mídia e MIME type baseado na extensão do arquivo ou header base64. Você pode fornecer manualmente se preferir.
