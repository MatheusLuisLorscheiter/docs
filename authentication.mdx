...
<Warning>
A API Disparador utiliza um sistema de autenticação simples baseado em tokens de acesso. Tokens não expiram automaticamente e devem ser mantidos seguros.
</Warning>
