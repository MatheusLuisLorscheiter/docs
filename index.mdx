...
<CardGroup cols={3}>
  <Card title="Campanhas" icon="rocket" href="/api-reference/campaigns">
    Disparos em massa com agendamento e mídias
  </Card>
  <Card title="Mídia" icon="paperclip" href="/api-reference/media">
    Upload e gestão de mídia
  </Card>
  <Card title="Automações" icon="sparkles" href="/api-reference/automations">
    Mensagens automáticas por segmentação
  </Card>
</CardGroup>
